		...
		<div id="product-grid">
			...
			?>
				<div class="product-item">
					...
					<div class="product-image"><a href="index.php?action=details&code=<?php echo $product_array[$key]["code"]; ?>"><img class="image_size" src="<?php echo $product_array[$key]["image"]; ?>"></a></div>
